...
<p class="my-pub-summary">We propose a reinforcement learning based method to identify important configurations that connect reactant and product states along chemical reaction paths, where an ensemble of configurations that concentrate on the transition path ensemble are generated. These configurations can be effectively employed in a NN-PDE solver to obtain a solution of a restricted Backward Kolmogorov equation, even when the dimension of the problem is very high. </p>
